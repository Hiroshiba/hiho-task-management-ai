  ...
  >
    ...
    >
      <button
        ...
        :key="row.gid"
        type="button"
        class="block w-full px-4 py-4 text-left hover:bg-slate-50 focus:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:px-5"
        :class="props.selectedTaskGid === row.gid ? 'bg-sky-50' : ''"
